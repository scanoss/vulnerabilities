...
func NewVulnsForPurlModel(ctx context.Context, conn *sqlx.Conn, project *projectModel, golangProj *GolangProjects) *VulnsForPurlModel {
	return &VulnsForPurlModel{ctx: ctx, conn: conn, project: project, golangProj: golangProj}
}
